                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-motive">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['motive']; ?>" 
                                    ...
                                    <tr  class="td-nex_appointment_date">
                                        <th class="title"> Nex Appointment Date: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-flatpickr="{ enableTime: false, minDate: '', maxDate: ''}" 
                                                data-value="<?php echo $data['nex_appointment_date']; ?>" 
                                                data-pk="<?php echo $data['id_appointment'] ?>" 
                                                data-url="<?php print_link("appointment_new/editfield/" . urlencode($data['id_appointment'])); ?>" 
                                                data-name="nex_appointment_date" 
                                                data-title="Enter Nex Appointment Date" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="flatdatetimepicker" 
                                                data-mode="popover" 
                                    ...
                                    <tr  class="td-id_status_appointment">
                                        <th class="title"> Id Status Appointment: </th>
                                        <td class="value">
