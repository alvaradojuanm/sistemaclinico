                            ...
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-motive"  value="<?php  echo $data['motive']; ?>" type="text" placeholder="Enter Motive"  required="" name="motive"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <textarea placeholder="Enter Description" id="ctrl-descritption"  required="" rows="5" name="descritption" class=" form-control"><?php  echo $data['descritption']; ?></textarea>
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <textarea placeholder="Enter Historial" id="ctrl-historial"  required="" rows="5" name="historial" class=" form-control"><?php  echo $data['historial']; ?></textarea>
                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                </div>
                                            </div>
                                        </div>
