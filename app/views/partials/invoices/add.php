                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-total_invoice"  value="<?php  echo $this->set_field_value('total_invoice',""); ?>" type="number" placeholder="Enter Total " step="0.1"  required="" name="total_invoice"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
